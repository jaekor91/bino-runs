...
ibool = (ra_star > ra_min-5) & (ra_star < ra_min+5) \
& (dec_star > dec_min-5) & (dec_star < dec_min+5)
data = data[ibool]
ra_star, dec_star, gmag_star = data["col1"].data, data["col2"].data, data["col4"].data # ra, dec, g-mag
...
ibool = (ra_gal > ra_min-5) & (ra_gal < ra_min+5) \
& (dec_gal > dec_min-5) & (dec_gal < dec_min+5)
data = data[ibool]
ra_gal, dec_gal, gmag_gal = data["col1"].data, data["col2"].data, data["col4"].data # ra, dec, g-mag
...
for i in range(1,7):
    ...
    ax_list[0, 0].scatter(ra_diff, dec_diff, c="black", edgecolors="none", s=5)
    ...
    ax_list[1, 0].hist(ra_diff, bins=np.arange(-2, 2, 0.05), color="black", histtype="step", lw=5)
    ...
    np.savez("./data/DR6-%d-sdss-gals.npz" % i, ra=ra_gal-ra_med_diff, dec=dec_gal-dec_med_diff, g=gmag_gal)
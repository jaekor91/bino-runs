...
ax.axis("equal")
# plt.show()
plt.savefig("DESI-ELG-field-candidates-SGC-0hr.png", dpi=200, bbox_inches="tight")
plt.close()    
...
np.save("DESI-ELG-fields-SGC-0hr-radec.npy", list_radec)
np.save("DESI-ELG-fields-SGC-0hr-coverage-fracs.npy", list_coverage_fracs)    